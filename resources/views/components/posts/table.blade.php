        ...
        <div class="bg-white dark:bg-gray-800 relative border sm:rounded-lg overflow-hidden">
            <div class="flex flex-col md:flex-row items-center space-y-3 md:space-y-0 md:space-x-4 p-4">
                ...
                <div class="w-full md:w-1/2 flex justify-end">
                    <a href="{{ route('dashboard.post.create') }}" type="button" class="inline-flex items-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">      
            ...
            <div class="flex justify-center items-center space-x-4">
                ...
                <form action="{{ route('dashboard.post.delete', $post->slug) }}" method="POST">
                    @csrf
                    @method('DELETE')
    ...
    <td colspan="6" class="px-6 py-16 text-center">
        <div class="flex flex-col items-center justify-center space-y-4">
            ...
            <div class="flex items-center justify-center w-16 h-16 rounded-full bg-gray-100 dark:bg-gray-700">
                <svg class="w-8 h-8 text-gray-400 dark:text-gray-300"
